	...
	<!--- Logo --->
		<div class="container">
           <nav class="menuPrincipal navbar fixed-top navbar-expand-md">
                <a class="tituloPrincipal navbar-brand mt-1"><img src="../img/balon_1.png" alt="Logo" class="logo"></a>
	...
	<!--- Formulario Login --->	
		<div class="formulario col-sm-6 text-center">
			...
			<form action="validar_login.php" method="POST">
				...
				<input type="text" class="ingreso_datos form-control rounded-0 my-4 text-left" name="usuario" placeholder="Usuario">
			...
			<button class="btn rounded">
				...
				<ul class="list-unstyled list-inline my-4">	<!-- Quita el esitlo que tiene por defecto la etiqueta ul -->
					...
					<li class="list-inline-item"> <a href="https://api.whatsapp.com/send?phone=573148136859&text=%C2%BFEn%20que%20puedo%20ayudarte?" target="blank"> 
